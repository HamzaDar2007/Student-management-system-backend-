...
export class TeachersController {
  ...
  @ApiResponse({ status: 200, description: 'Returns paginated list of teachers' })
  ...
  @ApiResponse({ status: 200, description: 'Returns teacher profile for the user' })
  ...
  @ApiParam({ name: 'id', type: 'number', description: 'Teacher profile ID' })
  @ApiResponse({ status: 200, description: 'Teacher profile deleted successfully' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin access required' })
  @ApiResponse({ status: 404, description: 'Teacher not found' })
