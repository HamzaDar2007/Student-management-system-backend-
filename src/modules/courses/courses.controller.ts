...
export class CoursesController {
  ...
  @Get('deleted/all')
  @Roles(UserRole.ADMIN)
  @ApiOperation({ summary: 'Get all soft-deleted courses (Admin only)' })
  @ApiResponse({ status: 200, description: 'Returns list of deleted courses' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Admin access required',
  })
  findDeleted() {
    return this.coursesService.findDeleted();
  }
