...
export class AttendanceController {
  ...
  @Post('bulk')
  @Roles(UserRole.ADMIN, UserRole.TEACHER)
  @ApiOperation({ summary: 'Create multiple attendance records at once (Admin/Teacher)' })
  ...
  @ApiResponse({ status: 200, description: 'Returns paginated list of attendance records' })
